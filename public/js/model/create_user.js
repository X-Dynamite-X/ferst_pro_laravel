...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="ModelShowLabel">${data.name}</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="row">
                <p class="col-2 ">ID:</p>
                <h5 class='col-2'>${data.id}</h5>
            </div>
            <div class="row">
                <p class="col-2 ">Username:</p>
                <h5 class='col-2'>${data.name}</h5>
            </div>
            <div class="row">
                <p class="col-2 ">Email:</p>
                <h5 class='col-2'>${data.email}</h5>
            </div>
            <div class="row">
                <p class="col-2 ">acteve:</p>
                    <h5 scope="row" class="col-3  ${
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                data-bs-target="#EditModel${data.id}"> Edit </button>
        </div>
    </div>
</div>
</div>
`;
                ...
                <div class="modal-dialog">
                    ...
                    data.id
                                    ...
                                    <input type="hidden" name="_token" value="2RblsjPlUxXuLBVr4XAW6gZSKEU1Lss03FmwHN1q" autocomplete="off">

            ...
            <div class="user_full_name">
                <div class="img_user_name">
                    <div class="background_img_user">
                        <img id="user_image" src="{{ asset('user_profile/image/' . $user->image) }}" alt="" class="background_img">
                        <div class="imag_user">
                        </div>
                    </div>
                    <div class="user_inf_name">
                        ...
                        <div class="inputBox">
                            ...
                            <input type="button" value="edit profile" data-bs-toggle="modal" data-bs-target="#edit_profile_model">
                        </div>
                    </div>
                </div>
            </div>
